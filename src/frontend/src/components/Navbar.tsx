...
const AppLogo: FC<AppLogoProps> = ({ sharedState }): ReactElement => {
  const [about, setAbout] = useState<any>({});
  const [pageTitle, setPageTitle] = useState<string>("");

  useEffect(() => {
    try {
      const about = sharedState.appInfo;
...
const Navbar: FC<NavbarProps> = ({ sharedState }): ReactElement => {
    ...
    >
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          >
            <AppLogo sharedState={sharedState} />
          </Typography>
